...
const ENGINE_CATALOG = {
  ...
  v2: { label: 'V2 Cross-Pattern', category: 'pairwise', engine: pairwiseEngines.v2 },
  'same-day': { label: 'Lunchtime to Teatime', category: 'pairwise', engine: pairwiseEngines['same-day'] },
  ...
  v3: { label: 'V3 Zubro Tracker', category: 'triplet', engine: null, implemented: true },
  ...
  calc: { label: 'Prediction Calc', category: 'tool', engine: null, implemented: true },
};
